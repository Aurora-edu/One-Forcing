#!/usr/bin/env python3
"""Audit that released Self-Forcing videos exactly cover the matched manifest."""
...
def main() -> None:
    ...
    payload = {
        ...
        "sorted_filename_sha256": ordered_digest,
    }
    ...
    print(f"PASS: audited {len(actual)} matched Self-Forcing videos: {output_path}")
